...
describe('types', () => {
  ...
  describe('isItemOmnipresent', () => {
    xit('returns true if the passed value is present in all the arrays inside the passed array', () => {
      const arrayOfArrays = [
        [9, 2, 3],
        [4, 5, 9],
        [-2, 9, -1],
    ...
    xit('returns false if the passed value is not present in at least one array inside the passed array', () => {
      let arrayOfArrays = [
        [9, 2, 3],
        [4, 5, 9],
        [-2, 1, -1],
